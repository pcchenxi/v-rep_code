...
//////////////////////////////////////////
struct setMotionValidationCallback_in
{
    int taskHandle;
    std::string callback;
...
struct setMotionValidationCallback_out
{
    int result;
    setMotionValidationCallback_out();
};
...
///////////////////////
struct motionValidationCallback_in
{
    std::vector<float> state_tree;
    std::vector<float> state;
    bool valid;
    motionValidationCallback_in();
};

struct motionValidationCallback_out
{
    bool valid;
    motionValidationCallback_out();
};
